...
function AddListing({ toast }) {
  ...
  return (
    <div className="py-16 bg-white dark:bg-surface-900">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold mb-8 text-center">Add Your Property Listing</h1>
        ...
        {/* Form Container */}
        <div className="bg-white dark:bg-surface-800 rounded-2xl shadow-soft dark:shadow-none border border-surface-200 dark:border-surface-700 overflow-hidden max-w-3xl mx-auto">
